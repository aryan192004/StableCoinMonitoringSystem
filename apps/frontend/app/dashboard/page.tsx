...
export default function DashboardPage() {
  ...
  // ✅ Only the two KPI cards you want
  const kpiData = [
    {
  ...
  const stablecoins = [
    { name: 'Tether', symbol: 'USDT', price: '$1.0001', marketCap: '$95.4B', volume: '$42.3B', pegDeviation: '+0.01%', riskScore: 0.32, change24h: 0.2 },
    { name: 'USD Coin', symbol: 'USDC', price: '$0.9999', marketCap: '$28.7B', volume: '$8.1B', pegDeviation: '-0.01%', riskScore: 0.18, change24h: -0.1 },
    { name: 'DAI', symbol: 'DAI', price: '$1.0003', marketCap: '$5.2B', volume: '$412M', pegDeviation: '+0.03%', riskScore: 0.24, change24h: 1.4 },
    { name: 'TrueUSD', symbol: 'TUSD', price: '$0.9998', marketCap: '$2.8B', volume: '$124M', pegDeviation: '-0.02%', riskScore: 0.28, change24h: -0.5 },
    { name: 'Binance USD', symbol: 'BUSD', price: '$1.0000', marketCap: '$4.1B', volume: '$1.2B', pegDeviation: '0.00%', riskScore: 0.22, change24h: 0.0 },
  ];
                ...
                {[
                  ...
                  <div key={i}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`text-sm font-semibold ${risk.color === 'success' ? 'text-success' : 'text-warning'}`}>
                        {risk.score.toFixed(2)}
                      </span>
                    </div>
                    <div className="h-1.5 bg-border rounded-full overflow-hidden">
                      <div
                        className={`h-full ${risk.color === 'success' ? 'bg-success' : 'bg-warning'} transition-all`}
          ...
          <Table>
            ...
            <TableBody>
              {stablecoins.map((coin, index) => (
                <TableRow key={index} onClick={() => router.push(`/dashboard/stablecoins/${coin.symbol.toLowerCase()}`)}>
                  <TableCell>
